                ...
                blocks: [
                    {
                        table: {
                            ...
                            rows: [
                                ...
                                ['role_hint', 'บอกว่าบัญชีเป็นลูกความหรือทนายความ เพื่อพาไปหน้าที่ถูกต้อง', '5 วัน หรือจนออกจากระบบ'],
                ...
                blocks: [
                    {
                        table: {
                            ...
                            rows: [
                                ...
                                ['role_hint', 'Whether the account is a client or lawyer, to route you to the right dashboard.', '5 days or until sign-out'],
                ...
                blocks: [
                    {
                        table: {
                            ...
                            rows: [
                                ...
                                ['role_hint', '标明账户是委托人还是律师，以进入正确的页面。', '5 天或至退出登录'],
