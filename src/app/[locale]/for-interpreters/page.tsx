...
export default async function ForInterpretersPage({ params }: { params: Promise<{ locale: string }> }) {
    const { locale } = await params;
    setRequestLocale(locale);
    const gpPercent = await getInterpreterGpPercentAction();
    return <ForInterpretersClient gpPercent={gpPercent} />;
}
