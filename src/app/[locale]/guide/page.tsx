...
export default function UserGuidePage() {
  ...
  const clientFeatures = [
    ...
    },
    {
      ...
      description: "เมื่อเปิดเคส คุณจะเข้าสู่ห้องพิจารณาคดีออนไลน์ ซึ่งเป็นพื้นที่ทำงานส่วนตัวระหว่างคุณและลูกความ สามารถติดตามความคืบหน้าของคดีผ่าน Visual Roadmap ได้ทันที",
