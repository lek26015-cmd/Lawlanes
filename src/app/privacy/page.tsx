      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-foreground/90 space-y-6">
            ...
            <h2 className="font-semibold text-xl">1. ข้อมูลที่เราเก็บรวบรวม</h2>
            ...
            <h2 className="font-semibold text-xl">2. เราใช้ข้อมูลของคุณอย่างไร</h2>
            ...
            <h2 className="font-semibold text-xl">3. การเปิดเผยข้อมูล</h2>
            <p>
            ...
            <h2 className="font-semibold text-xl">4. การใช้คุกกี้</h2>
            <p>
            ...
            <h2 className="font-semibold text-xl">5. สิทธิของเจ้าของข้อมูล</h2>
            ...
            <h2 className="font-semibold text-xl">6. การเปลี่ยนแปลงนโยบาย</h2>
