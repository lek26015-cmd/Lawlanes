...
START_YEAR = 2020
END_YEAR = 2026
CHECKPOINT_FILE = "scripts/checkpoint-ratchakitcha.json"
...
def update_local_status(status: str, message: str = "", next_retry: str = ""):
    # Heavy status updates to localhost:9002 was causing Next.js dev server panic (PoisonError).
    # We will just print to console for now to keep the server stable.
...
def main():
    print(f"🏛️ Ratchakitcha Ingestion (BACKWARDS) — Years {END_YEAR} to {START_YEAR}")
